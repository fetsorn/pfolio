...
[
    ...
    },
    {
      "inputs": [
        ...
        {
          "internalType": "uint256",
          "name": "baseBalanceAfterTx",
          "type": "uint256"
        },
        {
          "internalType": "uint256",
          "name": "quoteBalanceAfterTx",
          "type": "uint256"
        }
      ],
      "name": "checkSharesAfterTx",
      "outputs": [],
      "stateMutability": "view",
      "type": "function"
    },
...
function update() {
    ...
    token1.balanceOf(signerAddress).then((f) => {
        $("#balance1").html(numberIt(f.toString()));
    });
